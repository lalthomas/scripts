...
:SETFILE
REM set file="D:\lab\20131027-scripts project\20120909-make snapshots from videos-dos batch script.bat"
set file="%~dp020120909-make snapshots from videos-dos batch script.bat"
GOTO :EXECUTE
