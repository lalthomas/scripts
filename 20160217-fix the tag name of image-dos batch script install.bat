@echo OFF 	
REM File : 20160217-fix the tag name of image-dos batch script install.bat 	
REM Creation Date : 2019-11-27 	
REM Author : Lal Thomas 	
REM Original File : 20160217-fix the tag name of image-dos batch script.bat 	
...
:SETFILE
REM set file="D:\lab\20131027-scripts project\20160217-fix the tag name of image-dos batch script.bat"
set file="%scriptFolderPath%\20160217-fix the tag name of image-dos batch script.bat"
GOTO :EXECUTE
