@echo OFF 	
REM File : 20151226-git commit changes install.bat 	
REM Creation Date : 2019-11-27 	
REM Author : Lal Thomas 	
REM Original File : 20151226-git commit changes.bat 	
...
:SETFILE
REM set file="D:\lab\20131027-scripts project\20151226-git commit changes.bat"
set file="%~dp020151226-git commit changes.bat"
GOTO :EXECUTE
