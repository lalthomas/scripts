@echo OFF 	
REM File : 20170707-show image slideshow from a filelist-dos batch script install.bat 	
REM Creation Date : 2019-11-27 	
REM Author : Lal Thomas 	
REM Original File : 20170707-show image slideshow from a filelist-dos batch script.bat 	
