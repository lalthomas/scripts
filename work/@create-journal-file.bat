...
set filename="%datestamp%-monday work journal.md"
set copyfilename=planner-01-monday.md
GOTO CONTINUE

:tue
:: put your processing here
set filename="%datestamp%-tuesday work journal.md"
set copyfilename=planner-02-tuesday.md
GOTO CONTINUE

:wed
:: put your processing here
set filename="%datestamp%-wednesday work journal.md"
set copyfilename=planner-03-wednesday.md
GOTO CONTINUE

:thu
:: put your processing here
set filename="%datestamp%-thursday work journal.md"
set copyfilename=planner-04-thursday.md
GOTO CONTINUE

:fri
:: put your processing here
set filename="%datestamp%-friday work journal.md"
set copyfilename=planner-05-friday.md
GOTO CONTINUE

:sat
:: put your processing here
set filename="%datestamp%-saturday work journal.md"
set copyfilename=planner-06-saturday.md
GOTO CONTINUE

:sun
:: put your processing here
set filename="%datestamp%-sunday work journal.md"
...
REM copy the planner template file for specific day
type planner-section.md >> %filename%
echo Routines >>%filename%
REM add markdown heading 2 label
echo ^-------------- >>%filename%  
REM add a blank line
echo. >>%filename%
REM copy the planner template file for daily
type planner-daily.md >> %filename%
REM copy the planner template file for specific day
