...
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20111220-compile programs-dos batch script.bat" "# dev - compile.lnk"
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20120713-copy a file to all sub folders-dos batch script.bat" "# explorer - copy file to all sub folders.lnk"
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20120727-change file extension dos batch script.bat" "# explorer - change file extension.lnk"
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20120727-make folder with todays datestamp.bat" "# explorer - make folder with todays datestamp.lnk"
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20120909-make pictue mail from picture folder-dos batch scripts.bat" "# image - make pictue mail from picture folder.lnk"
...
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20130216-append foldername to filename-dos batch script.bat" "# explorer - append foldername to filename.lnk"
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20130728-prepend created datetime to filename-dos batch script.bat" "# explorer - prepend created datetime to filename.lnk"
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20130819-convert file to markdown using pandoc-dos batch script.bat" "# dev - convert html file to markdown.lnk"
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20131027-dev-beautify source code-dos batch script.bat" "# dev - beautify.lnk"
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20151226-git commit changes.bat" "# dev - git commit.lnk"
...
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20160217-fix the tag name of image-dos batch script.bat" "# image - fix the tag name of image.lnk"
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20160218-move files to random directory-dos batch program.bat" "# explorer - move files to random directory.lnk"
call :createShortCut "D:\Dropbox\project\20131027-scripts project\20160307-delete file and associated files-dos batch script.bat" "# explorer - delete file and associated files.lnk"
