@echo OFF 	
REM File : 20100827-run dev programs-dos batch script install.bat 	
REM Creation Date : 2019-11-27 	
REM Author : Lal Thomas 	
REM Original File : 20100827-run dev programs-dos batch script.bat 	
...
:SETFILE
REM set file="D:\lab\20131027-scripts project\20100827-run dev programs-dos batch script.bat"
set file="%~dp020100827-run dev programs-dos batch script.bat"
GOTO :EXECUTE
